...
public class DeliveryAdapter extends RecyclerView.Adapter<DeliveryAdapter.NotiViewHolder> {
    ...
    public  interface IClickReceive{
        ...
        void ClickCancel(Order order);
    }
    public DeliveryAdapter(List<Order> mList, IClickReceive iClickReceive) {
        this.mList = mList;
    ...
    public NotiViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NotiViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_delivery,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull NotiViewHolder holder, int position) {
        ...
        holder.btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIClickReceive.ClickCancel(order);
            }
        });
    }
    ...
    public static class NotiViewHolder extends RecyclerView.ViewHolder{
        ...
        public  Button btn_receive,btn_cancel;
